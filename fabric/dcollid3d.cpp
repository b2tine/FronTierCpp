        ...
        double k)
{
    ...
    {
        /*
        printf("vn = %g \t overlap = %g \t dt = %g\n",
                vn, overlap, dt);
        printf("fabs(vn)*dt = %g \t coef*overlap = %g\n",
                fabs(vn)*dt, coef*overlap);
        printf("dt*k*overlap/m = %g \t \
                coef*overlap/dt - fabs(vn) = %g\n",
                dt*k*overlap/m, coef*overlap/dt - fabs(vn));
        */
