...
static void modifyCanopySet(FILE*,SURFACE*);
...
extern void initFabricModules(Front* front)
{
	if (debugging("trace"))
	    printf("Entering initFabricModules()\n");
	...
	if (debugging("trace"))
	{
	    ...
	    printf("Leaving initFabricModules()\n");
	}
}
