...
void setRayleiTaylorParams(char *inname, EQN_PARAMS* eqn_params)
{
	int i;
	FILE *infile = fopen(inname,"r");
...
void setRichtmyerMeshkovParams(char *inname, EQN_PARAMS* eqn_params)
{
	FILE *infile = fopen(inname,"r");
	char s[100], str[256];
	double	pinf, einf, gamma;
...
void setBubbleParams(char *inname, EQN_PARAMS* eqn_params)
{
	int i;
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
...
void setImplosionParams(char *inname, EQN_PARAMS* eqn_params)
{
	int i;
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
...
void setMTFusionParams(char *inname, EQN_PARAMS* eqn_params)
{
	int i;
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
...
void setRiemProbParams(char *inname, EQN_PARAMS* eqn_params)
{
    int dim = eqn_params->dim;
	switch (dim)
	{
	case 1:
	    setRiemProbParams1d(inname,eqn_params);
	    return;
	case 2:
	    setRiemProbParams2d(inname,eqn_params);
	    return;
	}
}	/* end setRiemProbParams */

void setRiemProbParams2d(char *inname, EQN_PARAMS* eqn_params)
{
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
	char str[256];
...
void setRiemProbParams1d(char *inname, EQN_PARAMS* eqn_params)
{
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
	char str[256];
...
void setOnedParams(char *inname, EQN_PARAMS* eqn_params)
{
	FILE *infile = fopen(inname,"r");
	double		pinf,einf,gamma;
	char str[256];
