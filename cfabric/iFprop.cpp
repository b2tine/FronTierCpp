...
static void ifluid_compute_force_and_torque3d(Front*,HYPER_SURF*,double,double*,double*);
...
EXPORT void ifluid_point_propagate(
        Front *front,
        POINTER wave,
        POINT *oldp,
        POINT *newp,
...
EXPORT void ifluid_compute_force_and_torque(
        Front *fr,
        HYPER_SURF *hs,
        double dt,
        double *force,
