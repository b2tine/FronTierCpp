...
void CgalTriMesh2FTMonoCompSurf(Front*, Mesh*);
void CgalTriMesh2FTSurf(INTERFACE*, COMPONENT,
...
int main(int argc, char* argv[])
{
    ...
    CgalTriMesh2FTMonoCompSurf(&front,&mesh);
...
void CgalTriMesh2FTMonoCompSurf(Front* front, Mesh* mesh)
{
    SURFACE* surf;
    INTERFACE* intfc = front->interf;
    COMPONENT amb_comp = intfc->default_comp;
    CgalTriMesh2FTSurf(intfc,amb_comp,amb_comp,mesh,&surf);
...
void CgalTriMesh2FTSurf(INTERFACE* intfc, COMPONENT pos_comp,
