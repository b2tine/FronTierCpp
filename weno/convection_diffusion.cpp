...
int main(int argc, char **argv) 
{
    ...
    int buffer_size = 3;
	int imin,imax,mesh_size,expanded_mesh_size;
	int boundary_type[2];
	PARAMS params;
	double wave_speed;
	double err[3];
    ...
    FT_VectorMemoryAlloc((POINTER*)&u_old,mesh_size,sizeof(double));
    FT_VectorMemoryAlloc((POINTER*)&u_new,mesh_size,sizeof(double));
    FT_VectorMemoryAlloc((POINTER*)&cflux,mesh_size,sizeof(double));
    FT_VectorMemoryAlloc((POINTER*)&u_sol,mesh_size,sizeof(double));
